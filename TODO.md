...
- MeshCubeを"Torso"にしようとリネームしようとしたら
  - ```
    ---------------------------
    Recubin Studio - Error
    ---------------------------
    Recubin Studio が異常終了しました。
...
- [ ]SurfaceGui下のTextLabelはSurfaceGuiが属するCubeがWorkspace直下にないと描画リストに入らなくなるらしい

- [ ] DecalとMeshCubeのテクスチャの描画が特定のカメラ位置で壊れる。
  - ライン上に画像が連なってバグっている
