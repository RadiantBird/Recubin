...
- [ ] Box3D移行
  ...
  3. 差し替えて一通りの制約・挙動テスト
    - [x] stud系が維持されている
    - [ ] 制約が破綻していない
      - モーターの軸解釈がPhysXと異なっている可能性があり、タイヤが水平を向くようになっている。
        物理デバッグ表示は垂直であるため、これはバグ
    - [x] コンパウンドが維持されている

- Box3D版は浮力がめっちゃ強い
 - まあこれはバグというより、高精度化したらこれが正しい挙動ってことの可能性のほうが高いけど
 - ん？確か密度ってただの比率だったから、800倍にしたことで単純に800倍の力になったって感じかもしれない。
 - 水はデフォルトで1だった。でもこれは違うから、仕様変更して、20^3 = 8000 が水の体積か
 よくわからなくなってきた
### レンダリング関連
